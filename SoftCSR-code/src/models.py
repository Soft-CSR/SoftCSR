...
from modules import Encoder, LayerNorm,GRU4per

class SASRecGRU4per(nn.Module):
    def __init__(self, args):
        super(SASRecGRU4per, self).__init__()
    ...
    def add_position_embedding(self, sequence, VAT_embed):
    ...
    def forward(self, input_ids,VAT_embed):
        ...
        sequence_emb = self.add_position_embedding(input_ids,VAT_embed)
